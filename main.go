...
// Function rahisi ya kusimba password kwa kutumia sha256 ya asili ya Go
...
func signupHandler(w http.ResponseWriter, r *http.Request) {
	...
	_, err := db.Exec(`
		...
		username, hashedPassword, role, verificationStatus, idType, idNumber, idImageURL)
